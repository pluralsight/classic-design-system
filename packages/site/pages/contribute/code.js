...
Don’t feel bad if all good ideas don’t get included in the Design System or if we ask for changes during reviews.  We’re glad you’re here to help.  So are we.  Our shared goal is the betterment of the Design System and Pluralsight product as a whole.

## One-time code drop
It’s totally ok to make a contribution where you see the opportunity and then walk away the next day.  You don’t have to share in the maintenance.  You can make a contribution and then move on.  Come back and help when you’re ready again.
...
We generally prefer collaborating through pull requests as an asynchronous mode that allows the Design System team to serve many teams simultaneous and continue to work toward the ongoing vision of the project.

We will make ourselves available to one-on-one in-person or remote collaboration, including pairing.  This is especially useful when we’re just getting started together on a new feature, when design direction is not yet clear, when some feature is particularly difficult, or other reasons.  
...
Test your code.  Extract and use unit tests to exercise important logic.  Use snapshot tests to record healthy UI states.  Use the Design System Reference Site and/or a tool like Storybook to provide a quick-feedback visual environment for developing components.
...
Every code submission requires a review by the Design System team.  Be used to multiple iterations of feedback in a PR.  We'll ask questions back and forth. If you have other reviewers with relevant insight from other teams, please invite them to review your code as well.  

## After the PR is submitted
When a PR is submitted, we will insert its review into our pre-existing priority queue.  We will notify you when we intend to finish the review.  We will complete the first review within a max of 7 days of it being submitted, usually less.  
