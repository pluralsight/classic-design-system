...
interface FullOverlayLinkProps extends HTMLPropsFor<HTMLSpanElement> {}
...
interface ImageLinkProps extends HTMLPropsFor<HTMLSpanElement> {}
...
interface MetadataDatumProps extends HTMLPropsFor<HTMLSpanElement> {}
const MetadataDatum: React.FC<MetadataDatumProps> = props => {
  return <span {...styles.metadataDatum()} {...props} />
}

interface MetadataDotProps extends HTMLPropsFor<HTMLSpanElement> {}
...
interface OverlaysProps extends HTMLPropsFor<HTMLDivElement> {}
const Overlays: React.FC<OverlaysProps> = props => {
  return <div {...styles.overlays()} {...props} />
}

interface ProgressProps extends HTMLPropsFor<HTMLDivElement> {}
...
interface TextProps extends HTMLPropsFor<HTMLSpanElement> {}
const Text: React.FC<TextProps> = props => <span {...props} />
Text.displayName = 'Row.Text'

interface TextLinkProps extends HTMLPropsFor<HTMLSpanElement> {
