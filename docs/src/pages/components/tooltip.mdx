...
<Intro>
  The purpose of a tooltip is to provide context and explain the function of a user interface element or feature. The content of a tooltip is limited to styled text. If more customization is necessary, consider the <A href="/components/dialog">Dialog</A> component which builds on the patterns of the tooltip.
</Intro>
