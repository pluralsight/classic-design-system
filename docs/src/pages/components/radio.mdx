...
<Types.Table>
  ...
  <Types.Prop name="onChange" type="(Event, value: any) => ()" desc="triggers on radio select"/>
...
<Types.Table>
  ...
  <Types.Prop name="onBlur" type="(Event) => ()" desc="triggers on radio blur"/>
  <Types.Prop name="onClick" type="(Event, value: any) => ()" desc="triggers on radio select"/>
  <Types.Prop name="onFocus" type="(Event) => ()" desc="triggers on radio focus"/>
