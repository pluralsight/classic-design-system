...
<Usage install="npm install @pluralsight/ps-design-system-radio"
  import="import Avatar from '@pluralsight/ps-design-system-radio'"
  packageName="radio"
  />
...
<Types.Table>
  ...
  <Types.Prop name="onChange" type="function" desc="triggers on radio select" signature="(DOM event, value) => ()"/>
...
<Types.Table>
  <Types.Prop name="label" type="node" desc="display text"/>
  <Types.Prop name="onBlur" type="function" desc="triggers on radio blur" signature="(DOM event) => ()"/>
  <Types.Prop name="onClick" type="function" desc="triggers on radio select" signature="(DOM event, value) => ()"/>
  <Types.Prop name="onFocus" type="function" desc="triggers on radio focus" signature="(DOM event) => ()"/>
