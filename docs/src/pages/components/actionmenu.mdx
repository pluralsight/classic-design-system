...
<Types.Table>
  ...
  <Types.Prop name="onClick" type="(Event, value) => ()" desc="triggered when an item selected via click, enter or space"/>
...
<Types.Table>
  ...
  <Types.Prop name="onClick" type="(Event) => ()" desc="triggered on item select: click, enter or space" />
