...
<Types.Table>
  ...
  <Types.Prop name="label" type="React.ReactNode" desc="display name"/>
  <Types.Prop name="onCheck" type="(Event, checked: boolean, value: any, name: string) => void" desc="triggers on check toggle"/>
