...
import { ModalGuidelineExample } from '../../components/dialog'

# Dialog

<Intro>
  The purpose of a Dialog is to provide actionable messaging and may appear contextually or as a [modal](#modal). The Dialog adapts to various amounts and types of content. For contextual, non-actionable messaging, consider the [Tooltip](/components/tooltip) instead.
</Intro>
...
import { createUniversalPortal, usePortal } from '@pluralsight/ps-design-system-util'
import React from 'react'
