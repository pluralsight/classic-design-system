...
import { Guideline, Intro } from '../../components/component'
import { CenteredExample, PrincipleHeader, Quote, QuoteList } from '../../components/voice'
...
<Guideline
  do={
    <CenteredExample>
      <P><strong>Your credit card has expired</strong></P>
      <P>Update your payment method to restore your subscription.</P>
    </CenteredExample>
  }
  dont={
    <CenteredExample>
      <P><strong>Billing Error</strong></P>
    </CenteredExample>
  }
/>
...
<Guideline
  do={
    <CenteredExample>
      <P><strong>There was a problem loading the video</strong></P>
      <br />
...
<Guideline
  ...
  dont={
    <CenteredExample>
      <P>Yo, big problemo! The password you provided doesn’t match. Wanna try that again?</P>
    </CenteredExample>
  }
/>
...
<EqualColumnLayout count={EqualColumnLayout.counts.two}>
  <div>
    ...
    <P>
      ...
      use leading zeros on days. Feel free to abbreviate months. Use four
      digit year.
    </P>
  </div>
  <Quote>
