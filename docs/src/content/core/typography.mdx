...
Pluralsight’s monospace font family for the web is [Source Code Pro](https://fonts.google.com/specimen/DM+Mono).

<MonospaceGlyphs />

To use the Source Code Pro on your site, you can install it by importing it from [Google fonts](https://fonts.google.com/specimen/DM+Mono).
