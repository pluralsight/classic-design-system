...
Applying font weight using CSS vars:

```css
@import "@pluralsight/ps-design-system-core";

.mySelector { font-weight: var(--psTypeFontWeightStrong); }`}
```
...
Applying font sizes using CSS vars:
...
Applying letter spacing using CSS vars:
