...
<TypesTable>
  <TypesProp name="name" type="string" desc="used to generate intials as a fallback image" />
  <TypesProp name="size" type={<TypesEnum enum={Avatar.sizes}/>} desc="avatar size (from Avatar.sizes)" default="medium" />
  <TypesProp name="src" type="string" desc="URI or path to avatar image" />
</TypesTable>
