...
<TypesTable>
  <TypesProp name="brand" type="React.ReactNode" desc="global product branding" />
  <TypesProp name="items" type="React.ReactNode" desc="top-level nav affordances" />
  <TypesProp name="onMobileMenuClick" type="Event => ()" desc="displays hamburger menu; called on click" />
  <TypesProp name="utility" type="React.ReactNode" desc="top-right affordances next to user" />
  <TypesProp name="user" type="React.ReactNode" desc="user profile affordance" />
</TypesTable>
...
<TypesTable>
  <TypesProp name="alignment" type={<TypesEnum enum={NavItem.alignments} />} desc="orientation of item elements" default="horizontal" />
  <TypesProp name="bar" type="React.ReactNode" desc="active element indicator" />
  ...
  <TypesProp name="menu" type="boolean" desc="toggles render of down caret" default="false" />
  <TypesProp name="selected" type="boolean" desc="toggles active state" default="false" />
</TypesTable>
...
<TypesTable>
  <TypesProp name="cookieOptions" type="{ domain: string, expires: Date, secure: boolean, sameSite: string }" desc="attributes of cookie" />
  <TypesProp name="message" type="React.ReactNode" desc="messaging re cookies" />
  <TypesProp name="privacyUpdatedDate" type="Date" desc="date of last terms update" />
</TypesTable>
