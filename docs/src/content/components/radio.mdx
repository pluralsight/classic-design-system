...
<Intro>Radio buttons allow users to select a single option from a list of mutually exclusive options.</Intro>
...
WAI-ARIA Patterns: <A href="https://www.w3.org/TR/wai-aria-practices-1.2/#radiobutton" target="_blank" rel="noreferrer">Radio Group</A>
