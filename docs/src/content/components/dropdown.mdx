...
<TypesTable>
  <TypesProp name="appearance" type={<TypesEnum enum={Dropdown.appearances}/>} desc="visual style (from Dropdown.appearances)" default="default"/>
  <TypesProp name="disabled" type="boolean" desc="standard input disabled flag" />
  <TypesProp name="error" type="boolean" desc="error state flag"/>
  <TypesProp name="label" type="string" desc="identifying string for dropdown" />
  <TypesProp name="menu" type="Dropdown.Item(s)" desc="menu items for dropdown" default="<span></span>" />
  <TypesProp name="onChange" type="(Event, value, label) => void" desc="triggered when an item selected ((event, value, label) => ())" />
  <TypesProp name="placeholder" type="string" desc="in-field usage hint" />
  <TypesProp name="size" type={<TypesEnum enum={Dropdown.sizes}/>} desc="sets dorpdown size (from Dropdown.sizes)" default="medium" />
