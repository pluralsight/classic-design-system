...
<Intro>Text inputs are text boxes that allow users to input custom text entries with a keyboard.</Intro>
...
<TypesTable>
  <TypesProp
    name="appearance"
    type={<TypesEnum enum={TextInput.appearances} />}
  ...
  <TypesProp
    name="iconAlign"
    type={<TypesEnum enum={TextInput.iconAligns} />}
  ...
  <TypesProp
    name="size"
    type={<TypesEnum enum={TextInput.sizes} />}
