...
<TypesTable>
  <TypesProp name="appearance" type={<TypesEnum enum={TextInput.appearances}/>} desc="visual style (from TextInput.appearances)"/>
  <TypesProp name="disabled" type="boolean" desc="standard input disable flag"/>
  <TypesProp name="error" type="boolean" desc="error state flag"/>
  <TypesProp name="icon" type="*Icon" desc="An Icon component"/>
  <TypesProp name="iconAlign" type={<TypesEnum enum={TextInput.iconAligns}/>} desc="horizontal icon placement (from TextInput.iconAligns)"/>
  ...
  <TypesProp name="ref" type="Ref || { field: Ref,input: Ref, }" desc="refs to access underlying elements"/>
  <TypesProp name="size" type={<TypesEnum enum={TextInput.sizes}/>} desc="horizontal icon placement (from TextInput.sizes)"/>
