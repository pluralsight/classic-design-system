...
<Intro>Used to perform an action, or to navigate from a list of options.</Intro>
...
WAI-ARIA Patterns: <A href="https://www.w3.org/TR/wai-aria-practices-1.2/#menu" target="_blank" rel="noreferrer">Menu</A>
...
<TypesTable>
  ...
  <TypesProp
    name="origin"
    type={<TypesEnum enum={ActionMenu.origins} />}
