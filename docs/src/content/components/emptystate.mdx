...
<TypesTable>
  <TypesProp name="actions" type="EmptyState.Action" desc=""/>
  <TypesProp name="caption" type="EmptyState.Caption"/>
  <TypesProp name="heading" type="EmptyState.Heading"/>
  <TypesProp name="illustration" type="EmptyState.Illustration"/>
  <TypesProp name="size" type={<TypesEnum enum={EmptyState.sizes}/>} desc="disable resizing layout and set explicit size (from EmptyState.sizes)"/>
</TypesTable>

### EmptyState.Heading

<TypesTable>
  <TypesProp name="as" type="string" desc="heading tagName" default="h1"/>
</TypesTable>

### EmptyState.Illustration

<TypesTable>
  <TypesProp name="name"  type={<TypesEnum enum={EmptyState.Illustration.names}/>} desc="the illustration name (from Illustration.names)"/>
</TypesTable>
