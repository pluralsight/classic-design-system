...
If no illustration in the standard set is found to be suitable, you may officially [aire your grievance](https://github.com/pluralsight/design-system/issues/new/choose), or... consider creating a custom illustration within the guidelines of the predefined style.
