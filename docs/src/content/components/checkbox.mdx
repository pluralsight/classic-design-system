...
<TypesTable>
  <TypesProp name="checked" type="boolean" desc="marks as selected" default="false"/>
  ...
  <TypesProp name="indeterminate" type="boolean" desc="marks as indeterminate" default="false"/>
  <TypesProp name="name" type="string" desc="form data identifier"/>
  <TypesProp name="label" type="React.ReactNode" desc="display name"/>
  <TypesProp name="onCheck" type="(Event, checked: boolean, value: any, name: string) => void" desc="triggers on check toggle"/>
  <TypesProp name="value" type="string | number" desc="form value when checked"/>
</TypesTable>
