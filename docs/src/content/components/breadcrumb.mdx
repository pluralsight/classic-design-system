...
import { Intro, Guideline, Types, Usage } from '../../components/component'
...
<Types.Table>
  <Types.Prop name="children" type="React.ReactNode" desc="textual label" />
    <Types.Prop name="disabled" type="boolean" desc="standard input disable flag" default="false" />
  <Types.Prop name="href" type="string" desc="target url; renders anchor" />
    <Types.Prop name="loading" type="boolean" desc="shows loading animation" />
