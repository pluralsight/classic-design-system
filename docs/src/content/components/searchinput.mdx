...
<Intro>A text input specific for search.</Intro>
...
WAI-ARIA Patterns: <A href="https://www.w3.org/TR/wai-aria-practices-1.2/#aria_lh_search" target="_blank" rel="noreferrer">Search (landmark)</A>
