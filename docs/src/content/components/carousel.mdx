...
<TypesTable>
  <TypesProp name="children" required type="React.ReactNode" desc="items to place in carousel" />
  <TypesProp name="size" type={<TypesEnum enum={Carousel.sizes}/>} desc="size of carousel items" default="medium" />
</TypesTable>

### Carousel.Controls

<TypesTable>
  <TypesProp name="children" required type="React.ReactNode" desc="controls to advance carousel frames" />
</TypesTable>

### Carousel.Control

<TypesTable>
  <TypesProp name="direction" required type={<TypesEnum enum={Carousel.Control.directions} />} desc="(from Carousel.Control.directions)" />
</TypesTable>

### Carousel.Item

<TypesTable>
  <TypesProp name="children" required type="React.ReactNode | () => React.ReactNode" desc="render prop used to access item and page metadata" />
</TypesTable>
