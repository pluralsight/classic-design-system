  ...
  return (
    <>
      <Row
        progress={0}
        title="0% progress"
        image={<Row.Image src="/img/course1.jpg" />}
      />
      <Row
        progress={25}
        title="25% progress"
        image={<Row.Image src="/img/course2.jpg" />}
      />
      <Row
        progress={66.6666667}
        title="6.6666667% progress"
        image={<Row.Image src="/img/course3.jpg" />}
      />
      <Row
        progress={100}
        title="100% progress"
        image={<Row.Image src="/img/course4.jpg" />}
      />
    </>
  )
}
