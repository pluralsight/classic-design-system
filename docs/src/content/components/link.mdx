...
<Usage install="npm install @pluralsight/ps-design-system-link"
  import="import Link from '@pluralsight/ps-design-system-link'"
  packageName="link"
  />

<Types.Table>
  <Types.Prop name="appearance" type={<Types.Enum enum={Link.appearances}/>} desc="visual style (from Link.appearances)" default="default" />
</Types.Table>
