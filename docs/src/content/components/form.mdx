...
<Intro>The Form component helps arrange a form full of input controls. The package doesn't provide these controls but it is compatible with them.</Intro>
...
WAI-ARIA Patterns: <A href="https://www.w3.org/TR/wai-aria-practices-1.2/#aria_lh_form" target="_blank" rel="noreferrer">Form (landmark region)</A>
