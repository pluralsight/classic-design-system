...
import IconCommonSet from './icon-common-set'
...
Icons can be used at 4 sizes: xSmall (16px), Small (20px), Medium (24px), Large (48px)
...
const Comp = () => (
  <div className="example-flex-row">
    <StarIcon
      color={StarIcon.colors.textIconHighOnDark}
      size={StarIcon.sizes.large}
    />
    <StarIcon
      color={StarIcon.colors.textIconLowOnDark}
      size={StarIcon.sizes.large}
    />
    <StarIcon
      color={StarIcon.colors.textIconHighOnLight}
      size={StarIcon.sizes.large}
    />
    <StarIcon
      color={StarIcon.colors.textIconLowOnLight}
      size={StarIcon.sizes.large}
    />
...
<CheckCircleFilledIcon color="green" size="xSmall" /> 100% axe-core tests<br />
...
<TypesTable>
  <TypesProp
    name="color"
    type={<TypesEnum enum={Icon.colors} />}
    desc="color presets"
    default="currentColor"
  />
  <TypesProp
    name="size"
    type={<TypesEnum enum={Icon.sizes} />}
    desc="icon size (from *Icon.sizes)"
  />
</TypesTable>
