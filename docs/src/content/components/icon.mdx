...
<TypesTable>
  <TypesProp name="color" type={<TypesEnum enum={Icon.colors}/>} desc="color presets" default="currentColor"/>
  <TypesProp name="size" type={<TypesEnum enum={Icon.sizes}/>} desc="icon size (from *Icon.sizes)"/>
</TypesTable>
