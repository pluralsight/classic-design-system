...
<TypesTable>
  <TypesProp name="aria-label" required type="string" desc="description of dialog purpose" />
  <TypesProp name="disableCloseButton" type="boolean" desc="removes close button UI" default="false" />
  <TypesProp name="disableCloseOnEscape" type="boolean" desc="prevents closing Dialog with escape key" default="false" />
  <TypesProp name="disableCloseOnOverlayClick" type="boolean" desc="prevents clicking modal overlay to close Dialog" default="false" />
  <TypesProp name="disableFocusOnMount" type="boolean" desc="prevents focus the Dialog on render" default="false" />
  <TypesProp name="modal" type="boolean" desc="makes Dialog modal" default="false" />
  <TypesProp name="onClose" type="Event => void" desc="callback to be called by various close methods" />
  <TypesProp name="tailPosition" type={<TypesEnum enum={Dialog.tailPositions} />} desc="positions a tail pointer (from Dialog.tailPositions)" />
  <TypesProp name="returnFocus" type="boolean" desc="manage focus; set focus on call where closed" default="true"/>
</TypesTable>
