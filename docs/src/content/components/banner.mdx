...
<TypesTable>
  <TypesProp name="color" type={<TypesEnum enum={Banner.colors} />} desc="banner color (from Banner.colors)" default="blue" />
  <TypesProp name="onClick" type="Event => ()" desc="displays dismiss button, triggered on click" />
</TypesTable>
