...
<TypesTable>
  <TypesProp name="children" required type="React.ReactNode" desc="main data to display" />
  <TypesProp name="label" required type="string" desc="primary explanatory label"/>
