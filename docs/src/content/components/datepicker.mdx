...
<TypesTable>
  <TypesProp name="appearance" type={<TypesEnum enum={DatePicker.appearances}/>} desc="visual style (from DatePicker.appearances)" default="default" />
  ...
  <TypesProp name="onSubBlur" type="('mm/dd/yyyy') => void" desc="on subfield blur, returns null if invalid date" />
  <TypesProp name="onSelect" type="('mm/dd/yyyy') => void" desc="triggered when new valid date selected" />
  <TypesProp name="subLabel" type="string" desc="supporting text or error messaging" />
  <TypesProp name="value" type="string" desc="current date as a string (format mm/dd/yyyy)" />
</TypesTable>
