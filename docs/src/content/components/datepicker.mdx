...
import { DropdownDatePicker } from '@pluralsight/ps-design-system-datepicker'
import { DateObj } from 'dayzed'

interface DatePickerProps {
  onSelect: (evt: React.SyntheticEvent, dateObj: DateObj) => void
}
const DatePicker = (props: DatePickerProps) => <DropdownDatePicker onSelect={ props.onSelect} />
```
