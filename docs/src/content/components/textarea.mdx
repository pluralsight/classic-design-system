...
<TypesTable>
  <TypesProp name="disabled" type="boolean" desc="standard input disabled flag" default="false" />
  ...
  <TypesProp name="rows" type="number" desc="expand the viewable rows (height)" default="4"/>
