...
<TypesTable>
  <TypesProp name="href" type="string" desc="Destination of ”Contact support“ button" default="
...
<TypesTable>
  <TypesProp name="action" type="string" desc="Search form destination; handles q query string" />
</TypesTable>
